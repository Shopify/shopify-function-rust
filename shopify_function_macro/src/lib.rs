...
pub fn shopify_function(
    ...
    let deserialize_line: syn::Stmt = if cfg!(feature = "serde") {
        syn::parse_quote! {
    ...
    let serialize_line: syn::Stmt = if cfg!(feature = "serde") {
        syn::parse_quote! {
    ...
    let write_line: syn::Stmt = if cfg!(feature = "serde") {
        syn::parse_quote! {
...
pub fn typegen(
    ...
    let known_custom_scalar_types = HashMap::from([
        ...
        (
            ...
            KnownCustomScalarType {
                path_for_borrowed: None,
                path_for_owned: if cfg!(feature = "serde") {
                    syn::parse_quote! { ::shopify_function::serde_json::Value }
                } else {
                    syn::parse_quote! { ::shopify_function::miniserde::json::Value }
                },
            },
        ),
        (
